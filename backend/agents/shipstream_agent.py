...
class ShipStreamAgent(BaseAgent):
    ...
    def process_query(
        ...
        try:
            ...
            # If no order_id or tracking number, return empty result
            # Don't use generic query as it might reference tables that don't exist
            return {
    ...
    def _extract_tracking_number(self, query: str) -> Optional[str]:
        ...
        # Look for patterns like TRK followed by numbers
        import re
        pattern = r'TRK\d+'
